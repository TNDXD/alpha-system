...
client.on("message", message => {
 if (message.content === "-help") {
  const embed = new Discord.RichEmbed()
      .setColor("RANDOM")
      .setFooter('© AlphaDragon :heart: جميع الحقوق 2020 محفوظة')
...
client.on("message", message => {
 if (message.content === "-invite") {
  const embed = new Discord.RichEmbed()
      .setColor("RANDOM")
      .setFooter('© AlphaDragon :heart: جميع الحقوق 2020 محفوظة')
      .addField('© AlphaDragon :heart: جميع الحقوق 2020 محفوظة', `عذراً البوت خاص ل سيرفر ألفا دراقون ♥♥`)
  message.author.send({embed});
...
if (command == "غرد") {
    ...
    .setFooter('© . :Alpha Dragon || Copyright')
